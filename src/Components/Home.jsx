...
const Home = () => {
    return (
      <div className="bg-[#9873ff21]">
        <div className="max-w-6xl mx-auto banner py-7 flex items-center justify-between gap-16 ">
          <div className="banner-info">
            <h2 className="text-6xl font-bold leading-[80px] pb-6">
              One Step <br /> Closer To Your <span className="text-[#7183f8]">Dream Job</span>
            </h2>
